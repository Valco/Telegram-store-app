...
```env
# ============================================================
# ⚡ ОБОВ'ЯЗКОВО — БЕЗ ЦЬОГО ЗАСТОСУНОК НЕ ЗАПУСТИТЬСЯ
# ============================================================
...
# Безпека сесій (придумайте будь-який довгий рядок ≥32 символи)
JWT_SECRET_KEY="введіть-довгий-випадковий-рядок-мінімум-32-символи"
# Наприклад: xK9#mP2$qR7nL4wE8vT1hZsYbNcQdFgJ

# Адреса вашого сайту (з https://)
...
# ============================================================
# ⚡ ОБОВ'ЯЗКОВО — ДЛЯ ОПЛАТИ ТА ДОСТАВКИ
# ============================================================
...
# Email (SMTP) — для сповіщень про замовлення та OTP-входу
...
# ============================================================
# 🔑 ЛІЦЕНЗІЯ — ОБОВ'ЯЗКОВО ДЛЯ PRO ФУНКЦІЙ
# ============================================================

LICENSE_KEY=""
# Отримати ліцензійний ключ: https://license.dh-3d.com або @drukhouse3d

LICENSE_SERVER_URL="https://license.dh-3d.com"


# ============================================================
# 🔧 НЕ ОБОВ'ЯЗКОВО — можна внести з адмін-панелі пізніше
# ============================================================

# AI — Claude (для генерації описів товарів)
# Адмінка → Налаштування → AI
ANTHROPIC_API_KEY=""
# Отримати: console.anthropic.com

# AI — Photoroom (для обробки фото товарів)
# Адмінка → Налаштування → AI
...
# Amazon S3 (для зберігання зображень в хмарі)
# Адмінка → Налаштування → Сховище
AWS_ACCESS_KEY_ID=""
AWS_SECRET_ACCESS_KEY=""
AWS_BUCKET_NAME=""
AWS_REGION=""

# Фіскалізація — Checkbox (для видачі чеків)
# Адмінка → Налаштування → Фіскалізація
CHECKBOX_LICENSE_KEY=""


# ============================================================
# ⚙️ НАЛАШТУВАННЯ ДЕПЛОЮ (для CI/CD, не впливає на роботу)
# ============================================================
DEPLOY_USER="root"
...
## 🔄 Якщо ви змінили щось у файлі `.env`

> Застосунок **не перечитує `.env` автоматично**. Після будь-яких змін потрібно перезібрати і перезапустити сервіс.

**Якщо змінили звичайні налаштування** (SMTP, API-ключі тощо):
```bash
pm2 restart store-app
```
Перезапуск займає 5–10 секунд, сайт на цей час буде недоступний.

**Якщо змінили `DATABASE_URL`, `NEXT_PUBLIC_BASE_URL` або `LICENSE_KEY`** — потрібна повна перезбірка:
```bash
cd ~/projects/store && npm run build && pm2 restart store-app
```
Збірка займає 2–5 хвилин.

**Перевірити що сервіс запущений:**
```bash
pm2 status
```
Статус `online` — все добре ✅
