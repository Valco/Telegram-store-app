...
# Завантажуємо проект з GitHub (замініть URL на ваш репозиторій)
git clone https://github.com/ВАШ-ПРОФІЛЬ/ВАШ-РЕПОЗИТОРІЙ.git store
...
git clone https://github.com/ВАШ/РЕПОЗИТОРІЙ.git store
cd store
